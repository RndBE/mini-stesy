...
@section('content')
    <div class="max-w-3xl space-y-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Tambah Template Kategori Parameter</h1>
            <p class="text-sm text-slate-500">Tambahkan parameter template untuk kategori logger tertentu.</p>
        </div>

        <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <form action="{{ route('template-kategori-parameter.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" min="0" step="1" name="urutan" value="{{ old('urutan', 0) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="kolom_sensor_default" value="{{ old('kolom_sensor_default') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="satuan_override" value="{{ old('satuan_override') }}"
                            class="mt-1 w-full rounded-md border-slate-300 p-2 text-sm shadow-sm">
