    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('dataPerangkat', () => ({
                ...
                // Non-superadmin hanya punya satu instansi: langsung dipilihkan.
                lockedInstansiId: @json($instansis->count() === 1 ? (string) $instansis->first()->id : ''),
                ...
                formData: {
                    ...
                    nama_logger: '',
                    id_katlogger: '',
                    instansi_id: @json($instansis->count() === 1 ? (string) $instansis->first()->id : ''),
                    seri: '',
                    serial_number: '',
                    sensor_type: '',
                    no_hp: '',
                ...
                openCreateModal() {
                    this.formData = {
                        ...
                        nama_logger: '',
                        id_katlogger: '',
                        instansi_id: this.lockedInstansiId,
                        seri: '',
                        serial_number: '',
                        sensor_type: '',
                        no_hp: '',
