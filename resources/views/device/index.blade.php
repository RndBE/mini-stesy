        ...
        <div class="flex items-center justify-end">
            <div class="flex items-center gap-3">
                ...
                <div class="relative w-full sm:w-64">
                    <input type="text" x-model="searchQuery" @input="currentPage = 1" placeholder="Cari device..."
                    ...
                    <tbody class="divide-y divide-slate-200 bg-white">
                        <template x-for="(device, index) in paginatedDevices()" :key="device.id_logger || index">
                            <tr class="hover:bg-slate-50">
                                <td class="whitespace-nowrap px-6 py-4 font-medium text-slate-900" x-text="rowNumber(index)"></td>
            ...
            <div class="border-t border-slate-200 bg-white px-4 py-3 sm:px-6">
                <div class="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                    ...
                    <div
                        ...
                        <nav class="flex items-center justify-between gap-1" aria-label="Pagination Pengaturan Device">
