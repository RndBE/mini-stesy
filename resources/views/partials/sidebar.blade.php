        ...
        <nav class="px-3 sidebar-nav flex-1 overflow-y-auto">
            <div class="space-y-1">
                ...
                <a href="{{ route('notifikasi.index') }}"
                    ...
                    @else
                        <svg xmlns="http://www.w3.org/2000/svg" class="nav-ico h-5 w-5 flex-shrink-0" style="color:#000" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
