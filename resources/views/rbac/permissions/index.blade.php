                    ...
                    <tbody class="divide-y divide-slate-200 bg-white">
                        @forelse ($permissions as $index => $permission)
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 font-semibold text-slate-900">{{ $permission->permission_name }}</td>
                                <td class="whitespace-nowrap px-6 py-4">{{ $permission->roles_count }}</td>
        ...
        function permissionData() {
            return {
                ...
                async deletePermission(permissionId, permissionName) {
                    if (!confirm(`Hapus permission "${permissionName}"?`)) {
                        return;
                    }
